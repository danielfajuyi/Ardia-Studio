...
const plans = [
  {
    name: "Starter",
    price: "$999",
    features: ["5 AI Shorts/mo", "Basic Avatar usage", "720p Render", "Email Support"],
    variant: "secondary"
  },
  {
    name: "Pro",
    price: "$2,499",
    features: ["15 AI Shorts/mo", "Custom Avatar Training", "4K Render", "Priority Support", "Source Files"],
    variant: "glow",
    popular: true
  },
  {
    name: "Enterprise",
    price: "Custom",
    features: ["Unlimited Content", "Full Studio Access", "API Integration", "Dedicated Manager", "White Label"],
    variant: "secondary"
  }
];
...
const PricingCard = ({ plan, index }) => {
  return (
    ...
    >
      ...
      <div className="text-4xl font-bold mb-6">{plan.price}<span className="text-lg font-normal text-gray-500">{plan.price !== 'Custom' && '/mo'}</span></div>
    ...
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Choose the plan that fits your production needs.</p>
        </div>
