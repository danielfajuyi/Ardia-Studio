...
const Button = ({ children, className, variant = "primary", ...props }) => {
  ...
  const variants = {
    ...
    secondary:
      "bg-white/10 backdrop-blur-md border border-white/10 text-white hover:bg-white/20 hover:scale-105",
  ...
  return (
    <motion.button
      ...
      {...props}
    >
      <span className="relative z-10 flex flex-row items-center gap-2 justify-center">
        {children}
      </span>
      {variant === "primary" && (
