    ...
    <DashboardLayout role="admin">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {[
          ...
          { label: "Active Students", value: "843", icon: UsersIcon, color: "text-blue-400" },
          { label: "Course Views", value: "45.2k", icon: BarChart, color: "text-purple-400" },
        ].map((stat, i) => (
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="flex items-center justify-between py-2 border-b border-white/5 last:border-0">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-sm font-medium">User #{i}00{i}</div>
                    <div className="text-xs text-gray-500">AI Mastery Course</div>
                  </div>
                </div>
